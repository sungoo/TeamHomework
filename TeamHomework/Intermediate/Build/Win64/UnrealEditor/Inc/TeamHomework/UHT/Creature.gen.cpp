...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACreature_Statics::NewProp__isActive = { "_isActive", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ACreature), &Z_Construct_UClass_ACreature_Statics::NewProp__isActive_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__isActive_MetaData), NewProp__isActive_MetaData) };
void Z_Construct_UClass_ACreature_Statics::NewProp__isAttacking_SetBit(void* Obj)
{
	((ACreature*)Obj)->_isAttacking = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACreature_Statics::NewProp__isAttacking = { "_isAttacking", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ACreature), &Z_Construct_UClass_ACreature_Statics::NewProp__isAttacking_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__isAttacking_MetaData), NewProp__isAttacking_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACreature_Statics::NewProp__vertical = { "_vertical", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACreature, _vertical), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__vertical_MetaData), NewProp__vertical_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACreature_Statics::NewProp__horizontal = { "_horizontal", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACreature, _horizontal), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__horizontal_MetaData), NewProp__horizontal_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACreature_Statics::NewProp__height = { "_height", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACreature, _height), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__height_MetaData), NewProp__height_MetaData) };
